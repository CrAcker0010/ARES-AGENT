# Streaming LLM Response Support for Ares Agent
...
```
ARES_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ARES_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `ares_cli/config.py` | 1 | +streaming config defaults |
