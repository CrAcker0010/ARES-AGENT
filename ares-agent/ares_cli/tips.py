...
TIPS = [
    ...
    # --- MCP ---
    "ares mcp opens an interactive picker of Nous-approved MCPs you can install in one keystroke.",
    "ares mcp catalog lists Nous-approved MCP servers shipped with the repo.",
    "ares mcp install <name> installs a catalog entry, prompts for credentials, and lets you pick which of its tools to enable.",
    ...
    "ares auth add nous or ares auth add openai-codex sets up OAuth-based providers.",
    ...
    'ares dashboard embeds the full Ares TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'ares chat --ignore-user-config skips the active user config — reproducible bug reports and CI runs.',
