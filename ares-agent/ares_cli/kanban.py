...
from ares_cli import kanban_swarm as ks
from ares_cli.profiles import get_active_profile_name, get_profile_dir, seed_profile_skills
...
def _cmd_boards_rm(args: argparse.Namespace) -> int:
    # When the user runs `ares kanban boards delete <slug>` (alias), the
...
def _cmd_init(args: argparse.Namespace) -> int:
    ...
    # the kanban dispatcher can use them without a separate `ares profile
