...
def _should_skip_backup_file(abs_path: Path, rel_path: Path, out_path: Path) -> bool:
    ...
    # write can copy data from outside ARES_HOME.
...
# Relative path of the cron job database inside ARES_HOME. Kept in sync with
...
def restore_cron_jobs_if_emptied(
    ...
    """Safety net for silent cron-job loss across ``ares update``.
    ...
    Args:
        ...
        ares_home: Override for the Ares home directory (tests).
