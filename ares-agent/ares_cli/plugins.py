...
from ares_cli.middleware import OBSERVER_SCHEMA_VERSION, VALID_MIDDLEWARE
...
class PluginContext:
    ...
    def register_dashboard_auth_provider(self, provider) -> None:
        ...
        ``provider`` must be an instance of
        :class:`ares_cli.dashboard_auth.DashboardAuthProvider`. Used by
    ...
    def register_auxiliary_task(
        ...
        *,
        ...
        core files. After registration, the task:
          ...
          - Appears in the ``ares model → Configure auxiliary models`` picker
        ...
        # Lazy import to avoid circular: ares_cli.main imports plugins indirectly
        from ares_cli.main import _AUX_TASKS as _BUILTIN_AUX_TASKS
