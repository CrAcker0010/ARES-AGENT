...
required — uses aiohttp which is already a Ares dependency.
...
def interactive_setup() -> None:
    ...
    ``ares_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # ares_cli/setup.py::_setup_mattermost function.
