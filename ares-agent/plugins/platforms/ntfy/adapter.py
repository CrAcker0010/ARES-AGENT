"""ntfy platform adapter (Ares plugin).
...
``plugins/platforms/ntfy/``. The Ares plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "ares-in"              # subscribe topic (incoming)
          publish_topic: "ares-out"     # optional — defaults to topic
...
_ECHO_TAG = "ares-agent"  # tag added to outgoing messages for echo-loop prevention
...
async def _standalone_send(
    ...
    *,
    ...
    ``ares cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Ares dependency",
