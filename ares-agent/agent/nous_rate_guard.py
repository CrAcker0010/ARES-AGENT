...
(3 SDK retries x 3 Ares retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = os.path.join(os.path.expanduser("~"), ".ares")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Ares, ...) behind one endpoint.  A 429 can mean either:
