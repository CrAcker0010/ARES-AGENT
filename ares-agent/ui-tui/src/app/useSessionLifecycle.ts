...
import type { ScrollBoxHandle } from '@ares/ink'
import { evictInkCaches } from '@ares/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ARES_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
