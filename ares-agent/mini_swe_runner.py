#!/usr/bin/env python3
"""
SWE Runner with Ares Trajectory Format

A runner that uses Ares-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Ares-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Ares-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Ares format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Ares-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Ares-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Ares Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Ares-Agent's built-in execution environments
    and outputs trajectories in Ares-Agent format.
    """
    ...
    def _convert_to_ares_format(
        ...
        """
        Convert internal message format to Ares trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Ares trajectory format
        trajectory = self._convert_to_ares_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Ares trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Ares Trajectory Format")
    print("=" * 60)
