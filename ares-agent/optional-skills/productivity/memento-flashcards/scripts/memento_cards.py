...
Data file: $ARES_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ARES_HOME = Path(os.environ.get("ARES_HOME", Path.home() / ".ares"))
DATA_DIR = _ARES_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
