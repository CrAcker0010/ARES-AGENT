...
def _profile_user_agent() -> str:
    """Return a ``ares-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from ares_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"ares-cli/{_ver}"
    except Exception:
        return "ares-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # ares-cli UA so the catalog endpoint is reachable.
