...
Config: ~/.ares/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.ares/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_ares_home()`` helper (ARES_HOME-aware and
...
RULES_FILE = get_ares_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_ares_home() / "feishu_comment_pairing.json"
