...
Trust levels:
  - builtin:   Ships with Ares. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.ares/\.env|\~/\.ares/\.env',
     "ares_env_access", "critical", "exfiltration",
     "directly references Ares secrets file"),
    ...
    (r'\.ares/config\.yaml|\.ares/SOUL\.md',
     "ares_config_mod", "critical", "persistence",
     "references Ares configuration files directly"),
...
# scan. `.skillignore` is the Ares-native name; `.clawhubignore` is honored
