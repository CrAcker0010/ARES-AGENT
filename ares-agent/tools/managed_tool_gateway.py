...
def auth_json_path():
    """Return the Ares auth store path, respecting ARES_HOME overrides."""
    return get_ares_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`ares tools`, banner/status paint, provider
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from ares_cli.auth import resolve_nous_access_token
