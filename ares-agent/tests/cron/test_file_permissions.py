...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("ares_cli.config.get_config_path", return_value=config_path), \
             patch("ares_cli.config.ensure_ares_home"):
    ...
    def test_ensure_ares_home_sets_0700(self):
        home = Path(self.tmpdir) / ".ares"
        with patch("ares_cli.config.get_ares_home", return_value=home):
