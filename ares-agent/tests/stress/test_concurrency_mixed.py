...
def worker_loop(worker_id: int, ares_home: str, result_file: str) -> None:
...
def reclaimer_loop(ares_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="ares_mixed_stress_")
    print(f"ARES_HOME = {home}")
