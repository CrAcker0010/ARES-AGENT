...
The unit tests in tests/ares_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned ares-writable by the
...
from ares_cli.service_manager import S6ServiceManager
