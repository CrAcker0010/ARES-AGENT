...
# ``_load_provider_state`` itself, those helpers raise ``"Ares is not
...
def test_load_provider_state_falls_back_to_global(profile_env):
    ...
    from ares_cli.auth import _load_auth_store, _load_provider_state
...
def test_load_provider_state_classic_mode_no_fallback(tmp_path, monkeypatch):
    ...
    _write(ares_home / "auth.json", _make_auth_store(providers={
