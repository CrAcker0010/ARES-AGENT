"""Tests for the ``ares prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from ares_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(ares_home, memory_text="", user_text=""):
    mem_dir = ares_home / "memories"
...
def _seed_skill(ares_home, name, description):
    skill_dir = ares_home / "skills" / "demo" / name
