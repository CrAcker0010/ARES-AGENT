...
from ares_state import SCHEMA_SQL, SessionDB
...
class TestSessionLifecycle:
    ...
    def test_db_initializes_without_fts5_module(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("ares_state.sqlite3.connect", connect_without_fts)
    ...
    def test_fts_runtime_restores_triggers_after_no_fts_open(
        ...
        monkeypatch.setattr("ares_state.sqlite3.connect", real_connect)
...
class TestSchemaInit:
    ...
    def test_schema_version(self, db):
        from ares_state import SCHEMA_VERSION
