...
| | |
|---|---|
| Source | Optional — install with `ares skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Ares Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.ares/.env`:
