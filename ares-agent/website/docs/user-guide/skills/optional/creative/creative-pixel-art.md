...
| | |
|---|---|
| Source | Optional — install with `ares skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.ares/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.ares/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Ares installs package this)
