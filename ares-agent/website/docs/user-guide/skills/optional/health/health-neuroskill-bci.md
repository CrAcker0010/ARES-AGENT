...
| | |
|---|---|
| Source | Optional — install with `ares skills install official/health/neuroskill-bci` |
...
Connect Ares to a running [NeuroSkill](https://neuroskill.com/) instance to read
