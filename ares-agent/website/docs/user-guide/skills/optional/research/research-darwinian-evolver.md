...
| | |
|---|---|
| Source | Optional — install with `ares skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Ares Agent |
| License | MIT |
...
import upstream classes into Ares itself.
...
Open `~/.ares/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Ares core.
   Custom driver scripts under `~/.ares/skills/...` are user-side and fine.
