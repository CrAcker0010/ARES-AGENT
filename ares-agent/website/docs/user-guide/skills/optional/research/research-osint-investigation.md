...
| | |
|---|---|
| Source | Optional — install with `ares skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Ares Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $ARES_OSINT_CACHE/icij/ (default: ~/.cache/ares-osint/icij/).
...
# Set ARES_OSINT_UA=your-app/1.0 (your@email) to identify yourself
