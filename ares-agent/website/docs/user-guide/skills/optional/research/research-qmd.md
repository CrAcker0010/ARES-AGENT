...
| | |
|---|---|
| Source | Optional — install with `ares skills install official/research/qmd` |
...
Ares Agent via the native MCP client. This is the preferred
...
Then configure Ares Agent to connect via HTTP:
