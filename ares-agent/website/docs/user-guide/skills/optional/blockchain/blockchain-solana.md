...
| | |
|---|---|
| Source | Optional — install with `ares skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Ares Agent |
| License | MIT |
...
Helper script path: ~/.ares/skills/blockchain/solana/scripts/solana_client.py
