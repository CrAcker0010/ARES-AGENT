...
Both publish at:
  https://ares-agent.nousresearch.com/docs/llms.txt
  https://ares-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://ares-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Ares as a Python Library", None),
        ("guides/use-mcp-with-ares", "Use MCP with Ares", None),
        ("guides/use-voice-mode-with-ares", "Use Voice Mode with Ares", None),
        ("guides/use-soul-with-ares", "Use SOUL.md with Ares", None),
        ("guides/build-a-ares-plugin", "Build a Ares Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Ares"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "ares-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/ares-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Ares Agent — Full Documentation\n",
        (
            "This file is the entire Ares Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Ares, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://ares-agent.nousresearch.com/docs\n",
        "Short index: https://ares-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
