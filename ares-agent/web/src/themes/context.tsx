...
const STORAGE_KEY = "ares-dashboard-theme";
...
const FONT_STORAGE_KEY = "ares-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `ares_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "ares-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-ares-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-ares-theme-font", "true");
