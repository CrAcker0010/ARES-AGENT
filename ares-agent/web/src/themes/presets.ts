 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `ares_cli/web_server.py`.
 */
...
/**
 * Nous Blue — the inverted "light mode" Ares look, ported from the
 ...
 * nousnet-web's <body> is white; ares-agent's App root is `bg-black`,
