...
const SIDEBAR_COLLAPSED_KEY = "ares-sidebar-collapsed";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="ares-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="ares-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateAres,
      runningLabel: t.status.updatingAres,
      spin: false,
    },
  ];
