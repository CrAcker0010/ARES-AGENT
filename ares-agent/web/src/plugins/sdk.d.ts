/**
 * Ares Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__ARES_PLUGIN_SDK__`` and
 * ``window.__ARES_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__ARES_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``AresPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@ares/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__ARES_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__ARES_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__ARES_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface AresPluginSDK {
...
declare global {
  interface Window {
    __ARES_PLUGIN_SDK__?: AresPluginSDK;
    __ARES_PLUGINS__?: PluginRegistry;
  }
}
