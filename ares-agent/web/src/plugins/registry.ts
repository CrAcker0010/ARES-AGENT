 ...
 *
 * Plugins call window.__ARES_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__ARES_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__ARES_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ARES_PLUGIN_SDK__ = {
    ...
    // window.__ARES_SESSION_TOKEN__ directly.
    authedFetch,
