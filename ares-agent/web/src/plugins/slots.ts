 ...
 * `window.__ARES_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Ares brand in the top bar
 ...
 *  `window.__ARES_PLUGINS__.registerSlot(...)`.
 *
