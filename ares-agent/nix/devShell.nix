...
{ ... }:
{
  perSystem =
    ...
    let
      ...
      aresNpmLib = self'.packages.default.passthru.aresNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. ares-agent
    ...
    in
    {
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "Ares Agent dev shell"
          ${combinedNonNpm}
          ${aresNpmLib.mkNpmDevShellHook npmPackageJsonPaths fixLockfilesExe}
          echo "Ready. Run 'ares' to start."
        '';
      };
    };
}
