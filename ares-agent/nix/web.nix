# nix/web.nix — Ares Web Dashboard (Vite/React) frontend build
{ pkgs, aresNpmLib, ... }:
let
  npm = aresNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "ares-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../ares_cli/web_dist for the
