...
DEFAULT_DATASETS = [
    ...
    "NousResearch/ares-agent-megascience-sft1",
    "NousResearch/Ares-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Ares-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-ares-agent"
]
