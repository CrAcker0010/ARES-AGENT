#!/usr/bin/env python3
"""Build the Ares Model Catalog — a centralized JSON manifest of curated models.
...
Ares CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Ares release.
...
# Ensure ARES_HOME is set for imports that touch it at module level.
os.environ.setdefault("ARES_HOME", os.path.join(os.path.expanduser("~"), ".ares"))

from ares_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "ares-agent repo",
            "docs": "https://ares-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
