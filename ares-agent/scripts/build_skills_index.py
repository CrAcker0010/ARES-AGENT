#!/usr/bin/env python3
"""Build the Ares Skills Index — a centralized JSON catalog of all skills.
...
`ares skills search/install` can use it without hitting the GitHub API.
...
# Ensure ARES_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Ares Skills Index...", flush=True)
