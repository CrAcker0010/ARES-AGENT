...
import { launchAresDesktop } from '../store'
import { Rocket, AlertCircle } from 'lucide-react'

/*
 * Success screen. ARES AGENT wordmark stays as the visual anchor
 ...
 * Ares.exe doesn't exist). We catch the Tauri error and surface it
 * inline rather than silently doing nothing — the previous version
 * had `onClick={() => void launchAresDesktop()}` which swallowed
...
export default function Success() {
  ...
  return (
    <div className="ares-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>Ares is ready</span>
          </span>
          <span aria-hidden="true">Ares is ready</span>
        </p>
      ...
      >
        <Rocket size={18} />
        {launching ? 'Launching…' : 'Launch Ares'}
      </Button>
