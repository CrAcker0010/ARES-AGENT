...
cd apps/desktop
XCURSOR_SIZE=24 ARES_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/ares-typing
# → /tmp/ares-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/ares-typing.before.heapsnapshot
# → /tmp/ares-typing.after.heapsnapshot
```
