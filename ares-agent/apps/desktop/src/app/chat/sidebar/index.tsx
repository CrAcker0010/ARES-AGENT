...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/ares'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('ares:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('ares:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
