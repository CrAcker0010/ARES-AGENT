...
import { getAresConfigDefaults, getAresConfigRecord, saveAresConfig } from '@/ares'
...
export function SettingsView({ gateway, onClose, onConfigSaved, onMainModelChanged }: SettingsPageProps) {
  ...
  const exportConfig = async () => {
    try {
      const cfg = await getAresConfigRecord()
  ...
  const resetConfig = async () => {
    ...
    try {
      await saveAresConfig(await getAresConfigDefaults())
      triggerHaptic('success')
      onConfigSaved?.()
    } catch (err) {
