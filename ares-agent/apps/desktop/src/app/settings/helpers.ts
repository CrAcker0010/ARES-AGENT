import type { AresConfigRecord, ToolsetInfo } from '@/types/ares'
...
export function getNested(obj: AresConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: AresConfigRecord, path: string, value: unknown): AresConfigRecord {
...
function personalityOptions(config: AresConfigRecord): string[] {
