...
import { deleteSession, listSessions, setSessionArchived } from '@/ares'
...
import type { SessionInfo } from '@/types/ares'
...
// / Program Files), which buried any files Ares wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.aresDesktop` is
    ...
    const settings = window.aresDesktop?.settings
  ...
  return (
    <div className="mb-6">
      ...
      <ListRow
        ...
        description={dir || s.defaultsTo(fallback || '~/ares-projects')}
