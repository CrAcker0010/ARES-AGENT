...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/ares'
 ...
 * log inline — the GUI equivalent of the install step `ares tools` runs
