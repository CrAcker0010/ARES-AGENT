...
import { getAresConfigRecord, type AresGateway, saveAresConfig } from '@/ares'
...
function getServers(config: AresConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveAresConfig(nextConfig)
