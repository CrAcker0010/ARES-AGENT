...
describe('usePreviewRouting', () => {
  beforeEach(() => {
    ...
    Object.defineProperty(window, 'aresDesktop', {
      configurable: true,
      value: {
  ...
  it('does not infer previews from assistant prose', async () => {
    ...
    expect(window.aresDesktop.normalizePreviewTarget).not.toHaveBeenCalled()
  })
  ...
  it('registers structured tool-result preview targets', async () => {
    ...
    expect(window.localStorage.getItem('ares.desktop.sessionPreviews.v1')).toContain('./dist/index.html')
  })
