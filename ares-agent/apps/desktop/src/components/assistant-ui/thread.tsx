...
import { extractDroppedFiles, ARES_PATHS_MIME } from '@/app/chat/hooks/use-composer-actions'
import { ClarifyTool } from '@/components/assistant-ui/clarify-tool'
import { DirectiveContent, aresDirectiveFormatter } from '@/components/assistant-ui/directive-text'
...
import type { AresGateway } from '@/ares'
...
const StreamStallIndicator: FC<{ activity: string }> = ({ activity }) => {
  ...
  return (
    <StatusRow className="mt-1.5" data-slot="aui_stream-stall" label="Ares is thinking">
      <span aria-hidden="true" className="dither inline-block size-3 rounded-[2px] text-midground/80 animate-pulse" />
      <ActivityTimerText seconds={elapsed} />
    </StatusRow>
  )
