...
export const zhHant = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingAresDesktop: '正在啟動 Ares Desktop…'
    },
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverrideDesc:
        '取消設定 ARES_DESKTOP_REMOTE_URL 和 ARES_DESKTOP_REMOTE_TOKEN 後才會使用下方儲存的設定。',
      localTitle: '本機閘道',
      ...
      remoteUrlDesc: '遠端儀表板後端的基礎 URL。支援路徑前綴，例如 /ares。',
  ...
  commandCenter: {
    ...
    aresActiveSessions: (version, count) => `Ares ${version} · 活躍工作階段 ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot 使用者 ID', placeholder: '@ares:example.org' },
  ...
  cron: {
    ...
    newCron: '新排程工作',
    emptyDescNew:
      '按 cron 表達式排程一個提示詞。Ares 會執行它，並將結果傳送至您選擇的目的地。',
  ...
  updates: {
    ...
    applyingBody: 'Ares 更新程式會在自己的視窗中接管，並在完成後重新開啟 Ares。',
    applyingBodyBackend: '遠端後端正在套用更新並將重新啟動。恢復後 Ares 會自動重新連線。',
    applyingClose: 'Ares 將關閉以套用更新。',
    errorTitle: '更新未完成',
  ...
  install: {
    ...
    activeDesc:
      '這是一次性設定。Ares 安裝程式正在下載相依套件並設定您的電腦。之後啟動會略過此步驟。',
  ...
  onboarding: {
    ...
    autoBrowser: provider =>
      `已在瀏覽器中開啟 ${provider}。請在那裡授權 Ares，連線會自動完成，無需複製或貼上。`,
  ...
  preview: {
    ...
    web: {
      ...
      finishedRestarting: message =>
        `Ares 已完成預覽伺服器重新啟動${message ? `：${message}` : ''}`,
      ...
      stillWorking:
        'Ares 仍在執行，但尚未收到重新啟動結果。伺服器指令可能正在前台執行。',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `這會將「${pattern}」模式加入永久允許清單（~/.ares/config.yaml）。Ares 對類似指令將不再詢問，包括目前工作階段和未來工作階段。`,
      alwaysAllow: '一律允許'
    },
    clarify: {
      notReady: '澄清請求尚未就緒',
