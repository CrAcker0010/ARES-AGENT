...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingAresDesktop: 'Starting Ares Desktop…'
    },
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverrideDesc:
        'Unset ARES_DESKTOP_REMOTE_URL and ARES_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Ares backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Ares backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /ares.',
      ...
      restartingMessage: 'Ares Desktop will reconnect using the saved settings.',
  ...
  commandCenter: {
    ...
    aresActiveSessions: (version, count) => `Ares ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@ares:example.org' },
  ...
  updates: {
    ...
    applyingBody: 'The Ares updater will take over in its own window and reopen Ares when it’s done.',
    applyingBodyBackend: 'The remote backend is applying the update and will restart. Ares reconnects automatically when it’s back.',
    applyingClose: 'Ares will close to apply the update.',
  ...
  onboarding: {
    ...
    flowSubtitles: {
      ...
      loopback: 'Opens your browser to sign in — Ares connects automatically',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.ares/config.yaml). Ares won’t ask again for commands like this — in this session or any future one.`,
