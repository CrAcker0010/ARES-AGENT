...
const SIDEBAR_PINNED_STORAGE_KEY = 'ares.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'ares.desktop.agentsGroupedByWorkspace'
const SIDEBAR_CRON_OPEN_STORAGE_KEY = 'ares.desktop.sidebarCronOpen'
const SIDEBAR_SESSION_ORDER_STORAGE_KEY = 'ares.desktop.sessionOrder'
const SIDEBAR_WORKSPACE_ORDER_STORAGE_KEY = 'ares.desktop.workspaceOrder'
const PANES_FLIPPED_STORAGE_KEY = 'ares.desktop.panesFlipped'
...
export const SESSION_SEARCH_FOCUS_EVENT = 'ares:focus-session-search'
