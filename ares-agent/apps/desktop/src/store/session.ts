...
import type { SessionInfo, UsageStats } from '@/types/ares'

type Updater<T> = T | ((current: T) => T)

const WORKSPACE_CWD_KEY = 'ares.desktop.workspace-cwd'
...
export const $connection = atom<AresConnection | null>(null)
...
export const setConnection = (next: Updater<AresConnection | null>) => updateAtom($connection, next)
