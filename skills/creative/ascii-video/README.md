...
Built for [Ares Agent](https://github.com/NousResearch/ares-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/ares-agent/skills/creative/ascii-video`](https://github.com/NousResearch/ares-agent/tree/main/skills/creative/ascii-video) via PR.
